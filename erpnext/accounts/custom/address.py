...
def get_shipping_address(company, address=None):
	...
	# doc= so the named company is evaluated, which is what brings User Permissions to bear; a
	# doctype-only check would let a caller restricted to one company name another.
