...
def get_project_name(
	...
	# project_name containing search string 'txt' will be given higher precedence. CASE, not IF():
	# IF() is MariaDB-only and is emitted verbatim, so it fails on postgres.
	q = q.orderby(
